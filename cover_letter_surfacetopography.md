...
**Status.** Single-author paper; not under consideration elsewhere. A supplementary file (method derivations, robustness tests, calibration and traceability details) accompanies the submission. All code is available from the corresponding author and will be deposited in a permanent Zenodo repository upon acceptance; the validation data are publicly available (Mendeley Data), as stated in the manuscript.
