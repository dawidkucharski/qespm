...
persistent and growing need exists for \emph{non-contact} surface
...
already operate \emph{in situ} in UHV and at cryogenic temperatures, they
...
leading correction to the frequency shift is \emph{linear} in the
...
QESPM the band-pass response is the \emph{native, continuous,
...
\emph{reducing $h$} --- which shifts the entire singular-value
