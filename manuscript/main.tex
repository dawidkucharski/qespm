...
least squares extracts $\ell_c$ with standard error
$\mathrm{SE}(\ell_c)$; a fitted value
$\ell_c < 1.96\,\mathrm{SE}(\ell_c)$ (one-sided $95\%$ level) indicates
a white-noise spectrum and rejects the correlated-patch hypothesis.
